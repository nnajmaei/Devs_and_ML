...
if [[ " ${tasks_to_run[*]} " =~ " 2 " ]]; then
    ...
    isort_directories=("ArcPyUtils" "daemons" "core_utils"  "errorID_mgmt" "TrajektStereoVision" "TrajektBallDetection" "firmware" "machine-configs" "manufacturing_notebooks" "notebooks-updated" "MockAMPMotor")
